...
RSpec.describe Match::MinuteByMinute::MinuteByMinutePress, type: :model do
  describe 'calculate match_squad totals with positive press values' do
    it 'based on a press of 1 for the home side and 2 for the away side in the 9th minute' do
      ...
      all_teams = [{ club_id: '1', defense: 200, midfield: 200, attack: 100 },
                   { club_id: '2', defense: 200, midfield: 200, attack: 100 }]
      ...
      expect(minute_by_minute_press[0][:defense_press]).to eq(200)
      expect(minute_by_minute_press[0][:midfield_press]).to eq(260)
      expect(minute_by_minute_press[0][:attack_press]).to eq(160)
      expect(minute_by_minute_press[1][:defense_press]).to eq(200)
      expect(minute_by_minute_press[1][:midfield_press]).to eq(236)
      expect(minute_by_minute_press[1][:attack_press]).to eq(136)
    end
    ...
    it 'based on a press of 3 for the home side and 4 for the away side in the 49th minute' do
      ...
      expect(minute_by_minute_press[0][:defense_press]).to eq(200)
      expect(minute_by_minute_press[0][:midfield_press]).to eq(206)
      expect(minute_by_minute_press[0][:attack_press]).to eq(106)
      expect(minute_by_minute_press[1][:defense_press]).to eq(200)
      expect(minute_by_minute_press[1][:midfield_press]).to eq(200)
      expect(minute_by_minute_press[1][:attack_press]).to eq(100)
    end
    ...
    it 'based on a press of 5 for the home side and 6 for the away side in the 89th minute' do
      ...
      expect(minute_by_minute_press[0][:defense_press]).to eq(200)
      expect(minute_by_minute_press[0][:midfield_press]).to eq(220)
      expect(minute_by_minute_press[0][:attack_press]).to eq(120)
      expect(minute_by_minute_press[1][:defense_press]).to eq(200)
      expect(minute_by_minute_press[1][:midfield_press]).to eq(232)
      expect(minute_by_minute_press[1][:attack_press]).to eq(132)
    end
  end
end
