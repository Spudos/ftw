...
RSpec.describe Match::PressingEffect, type: :model do
  describe 'calculate match_squad totals with positive press values' do
    ...
    let(:tactic1) { double('Tactic', club_id: 1, press: 1) }
    let(:tactic2) { double('Tactic', club_id: 2, press: 2) }
    ...
    it 'based on a press of 1 for the home side and 2 for the away side in the 9th minute' do
      ...
      expected_match_squad = [
        { team: 1, defense: 200, midfield: 156, attack: 106 },
        { team: 2, defense: 250, midfield: 212, attack: 162 },
      ]
    ...
    it 'based on a press of 1 for the home side and 2 for the away side in the 49th minute' do
      ...
      expected_match_squad = [
        { team: 1, defense: 200, midfield: 152, attack: 102 },
        { team: 2, defense: 250, midfield: 204, attack: 154 },
      ]
    ...
    it 'based on a press of 1 for the home side and 2 for the away side in the 89th minute' do
      ...
      expected_match_squad = [
        { team: 1, defense: 200, midfield: 146, attack: 96 },
        { team: 2, defense: 250, midfield: 192, attack: 142 },
      ]
  ...
  describe 'calculate match_squad totals with positive press values' do
    ...
    it 'based on a press of -1 for the home side and -2 for the away side in the 9th minute' do
      ...
      expected_match_squad = [
        { team: 1, defense: 200, midfield: 144, attack: 94 },
        { team: 2, defense: 250, midfield: 188, attack: 138 },
      ]
    ...
    it 'based on a press of -1 for the home side and -2 for the away side in the 49th minute' do
      ...
      expected_match_squad = [
        { team: 1, defense: 200, midfield: 148, attack: 98 },
        { team: 2, defense: 250, midfield: 196, attack: 146 },
      ]
    ...
    it 'based on a press of -1 for the home side and -2 for the away side in the 89th minute' do
      ...
      expected_match_squad = [
        { team: 1, defense: 200, midfield: 154, attack: 104 },
        { team: 2, defense: 250, midfield: 208, attack: 158 },
      ]
  ...
  describe 'calculate match_squad totals with no press set' do
    ...
    let(:tactic1) { double('Tactic', club_id: 1, press: nil) }
    let(:tactic2) { double('Tactic', club_id: 2, press: nil) }
    ...
    it 'based on a press of null for the home side and null for the away side in the 9th minute' do
      ...
      expected_match_squad = [
        { team: 1, defense: 200, midfield: 150, attack: 100 },
        { team: 2, defense: 250, midfield: 200, attack: 150 },
      ]
