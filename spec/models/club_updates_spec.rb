...
RSpec.describe Club::ClubUpdates, type: :model do
  let(:week) { 1 }
  ...
  describe 'Match_income' do
    it 'should increase the bank balance all streams of income for a match day' do
      ...
      club_updates = []
      resolver = Club::Engines::MessageTypeResolver.new(club_updates)
      Club::Engines::ClubMatchDayIncome.new(week, resolver).process
