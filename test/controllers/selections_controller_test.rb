...
class SelectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create selection" do
    assert_difference("Selection.count") do
      post selections_url, params: { selection: { club: @selection.club, player_id: @selection.player_id } }
    end
  ...
  test "should update selection" do
    patch selection_url(@selection), params: { selection: { club: @selection.club, player_id: @selection.player_id } }
