...
class TurnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turn" do
    assert_difference("Turn.count") do
      post turns_url, params: { turn: { club: @turn.club, var1: @turn.var1, var2: @turn.var2, var3: @turn.var3, week: @turn.week } }
    end
  ...
  test "should update turn" do
    patch turn_url(@turn), params: { turn: { club: @turn.club, var1: @turn.var1, var2: @turn.var2, var3: @turn.var3, week: @turn.week } }
